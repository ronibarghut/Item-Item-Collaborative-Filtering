...
public class about extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ev) {
		...
		if (commandName.equals("UpdateFiles")) {
            ...
            win.setVisible(true); 
			// this.dispose();
		} else if (commandName.equals("Explaination")) {
			stepOne win = new stepOne();
			this.dispose(); 
            win.setVisible(true); 
			// this.dispose();
		}
